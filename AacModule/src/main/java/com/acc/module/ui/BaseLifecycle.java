...
public abstract class BaseLifecycle<ActivityType> implements LifecycleObserver{
     ...
     * @param modelClass viewModel 类型
     **/
    public <ViewModelType extends ViewModel> ViewModelType gettApplicationViewModel(Class<ViewModelType> modelClass) {
