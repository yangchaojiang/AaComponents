...
public abstract class BaseDefaultListActivity<P extends BaseDefaultLAPresenter, M> extends BaseLifecycleActivity<P>
        implements SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener {
    private static final String TAG = BaseDefaultListActivity.class.getName();
